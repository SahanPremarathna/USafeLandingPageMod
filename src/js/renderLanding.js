...
export function renderLanding(root, content) {
    ...
    root.innerHTML = [
        ...
        '        </ul>',
        '        <button class="button button-primary nav-cta" data-download-cta type="button">', content.navigation.cta.label, '</button>',
        '      </div>',
        '    </div>',
        '  </nav>',
        ...
        '        <button class="footer-download-cta" data-download-cta type="button">',
        '          <i class="fa-solid fa-download" aria-hidden="true"></i> Try USafe',
        '        </button>',
        '      </div>',
